...
<section class="mt-6 rounded-[22px] bg-[#F5F5F7] px-5 py-5">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-[17px] font-semibold text-[#1D1D1F]">Ratings</h2>
            <div class="mt-2 flex items-center gap-3">
                <p class="font-display text-[36px] font-bold leading-none tabular-nums text-[#1D1D1F]">
            ...
            @auth
                ...
                >
                    ...
                    @for ($i = 1; $i <= 5; $i++)
                        ...
                        >
                            <svg class="h-8 w-8" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                        </button>
                    @endfor
                </form>
            @else
