...
<body
    ...
    <div class="store-shell">
        ...
        >
            ...
            <div class="mt-3 space-y-2 border-t border-[#D2D2D7] px-2.5 pt-3">
                <a
                    href="{{ route('docs') }}"
                    class="side-link {{ request()->routeIs('docs') ? 'side-link-active' : '' }}"
                    @click="mobileNav = false"
                >
                ...
                <p class="px-2.5 text-[11px] text-[#86868B]">&copy; {{ date('Y') }} AppsRecord</p>
            </div>
        </aside>
